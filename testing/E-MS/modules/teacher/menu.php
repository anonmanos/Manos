...
<div style="padding: 8px 0;" class="well">
	<ul class="nav nav-list">
		<li class="active"><a href="index.php?mod=teacher"><i class="icon-home icon-white"></i> หน้าหลักครูผู้สอน</a></li>
		<li><a href="index.php?mod=teacher&name=major"><i class="icon-cog"></i> จัดการวิชา</a></li>
		<li><a href="index.php?mod=teacher&name=profile"><i class="icon-edit"></i> ข้อมูลส่วนตัว</a></li>
