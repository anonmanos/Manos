      ...
      <td>
		<div class="btn-group">
          ...
          <ul class="dropdown-menu">
            <?php /*<li><a href="index.php?mod=admin&name=student&act=edit&id=<?php echo $rs['id'];?>"><i class="icon-pencil"></i> แก้ไขข้อมูล</a></li> */?>
...
if($act==='lock'):
	...
	if(UpdateDB(USER,$sql,"id='".$_GET['id']."' AND login='F'"))
		echo '<meta http-equiv="refresh" content="0;URL=index.php?mod=admin&name=student">';
	else{
		$ms = array(
