...
<div style="padding: 8px 0;" class="well">
	<ul class="nav nav-list">
		<li class="active"><a href="index.php?mod=admin"><i class="icon-home icon-white"></i> หน้าหลักผู้ดูแลระบบ</a></li>
		<li><a href="index.php?mod=admin&name=profile"><i class="icon-edit"></i> ข้อมูลส่วนตัว</a></li>
